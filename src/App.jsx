  ...
  return (
    <>
      ...
      <MainSection>
        ...
        <Box>
          {selectedId ? (
            <MovieDetails selectedId={selectedId} handleCloseDetails={handleCloseDetails} onAddWatched={handleAddWatched} watched={watched} />
          ) : (
            <>
...
const MovieDetails = ({ selectedId, handleCloseDetails, onAddWatched, watched }) => {
